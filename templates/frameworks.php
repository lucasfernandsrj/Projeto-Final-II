...
<script type="text/javascript" src="lib/datatables/dataTables.bootstrap4.min.js"></script>
<!-- Charts -->
<script type="text/javascript" src="lib/chartjs-plugin-datalabels.min.js"></script>
<!-- Datatables -->
<script type="text/javascript" src="lib/datatables.js"></script>
<!-- Input mask -->
<script type="text/javascript" src="lib/jquery.mask.min.js"></script>
<!-- FontAwesome -->
<script type="text/javascript" src="lib/fontawesome-free/js/all.min.js"></script>

<!-- JavaScript JQuery v3.5.1 / Pooper v2.4.4 / Bootstrap v4.5.0 / MDB / Loader -->
<script type="text/javascript" src="lib/bootstrap.js"></script>
<!-- StartBootstrap - SB-Admin-2 -->
<script type="text/javascript" src="lib/sb-admin-2.min.js"></script>
